...
MIGRATION_PATH=$(./scripts/migrations/postgresql/go-migrate/run/paths/migration-path.sh "$DOMAIN_NAME")
DB_SOURCE_URL=$(./scripts/migrations/postgresql/go-migrate/urls/db-url.sh "$DB_ENV_NAME")
